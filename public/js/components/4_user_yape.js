const userYape = (update) => {
  ...
  const row1       =$('<div class="row margin_bot_none"></div>');
  ...
  const inputname  =$('<div class="input-field col s12"><div class="col s3"><img src="../../img/icons/user.png" class="icono_medium" alt="user"></div></div>');
  ...
  const inputemail =$('<div class="input-field col s12"><div class="col s3"><img src="../../img/icons/message-gray.png" class="icono_medium" alt="message"></div></div>');
  ...
  const inputclave =$('<div class="input-field col s12"><div class="col s3"><img src="../../img/icons/lock.png" class="icono_medium" alt="lock"></div></div>');
  ...
  const btn_create_count  =$('<button id="btn_create_count" class="btn disabled">CREAR CUENTA</button>');
  ...
  form.append(coment);
  divbtn.append(btn_create_count);
  form.append(divbtn);
